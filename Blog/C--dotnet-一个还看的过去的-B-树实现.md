...
因为这个 B 树也许只有在教科书上面才有用，因此比较难会用到真实的需求上，因此大部分对他的实现也仅仅是能实现出来。包括 [https://github.com/justcoding121/Advanced-Algorithms](https://github.com/justcoding121/Advanced-Algorithms) 这个比较有名的项目

本文是从 [https://github.com/justcoding121/Advanced-Algorithms](https://github.com/justcoding121/Advanced-Algorithms) 魔改的，最大的更改是修复命名错误问题，以及导入了 IValueComparer 接口，开放了 Find 方法
...
下面代码放在 [github](https://github.com/lindexi/lindexi_gd/tree/6eb1350509a439f6c227b93834b480293408e06a/JerecarwirakalHallnanemne) 欢迎小伙伴访问
