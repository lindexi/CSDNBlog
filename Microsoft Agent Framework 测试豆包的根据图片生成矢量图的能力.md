...
<!-- ![](image/Microsoft Agent Framework 测试豆包的根据图片生成矢量图的能力/Microsoft Agent Framework 测试豆包的根据图片生成矢量图的能力2.png) -->
![](http://cdn.lindexi.site/lindexi-2026631440502467.jpg)
...
<!-- ![](image/Microsoft Agent Framework 测试豆包的根据图片生成矢量图的能力/Microsoft Agent Framework 测试豆包的根据图片生成矢量图的能力3.png) -->
![](http://cdn.lindexi.site/lindexi-2026631441329134.jpg)

```xml
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 900" width="100%" height="100%">
  <!-- 1. 背景底色 (深蓝色) -->
  <path d="M0,0 H500 V900 H0 Z" fill="#051525" />

  <!-- 2. 背景战甲剪影 (深青色/深灰色) -->
  <path d="M 260,120 C 260,60 290,40 320,40 C 350,40 380,60 380,120 L 390,180 C 420,200 450,220 480,280 L 500,350 L 500,900 L 200,900 L 200,600 C 200,500 220,400 250,350 C 240,300 230,250 240,200 Z" fill="#1a3545" />

  <!-- 背景战甲细节线条/阴影 -->
  <path d="M 280,200 L 360,200 L 380,250 L 320,300 Z" fill="#102530" opacity="0.5"/>

  <!-- 3. 背景战甲发光部分 (眼睛和胸口) -->
  <!-- 背景眼睛 -->
  <path d="M 280,110 L 310,110 L 310,120 L 280,120 Z" fill="#00ffff" />
  <path d="M 330,110 L 360,110 L 360,120 L 330,120 Z" fill="#00ffff" />
  <!-- 背景胸口反应堆 (大光团) -->
  <path d="M 300,380 C 300,350 340,340 360,360 C 390,380 390,430 360,450 C 330,470 290,460 300,380 Z" fill="#88eeff" />
  <path d="M 320,390 C 320,370 340,370 350,380 C 370,390 370,420 350,430 C 330,440 310,430 320,390 Z" fill="#ffffff" />

  <!-- 4. 前景人物：头部与脸部 -->
  <!-- 头发 (黑色) -->
  <path d="M 180,160 C 180,110 220,100 250,120 C 270,130 280,160 270,180 C 260,160 240,150 220,150 C 200,150 190,170 180,160 Z" fill="#111111" />
  <!-- 脸部肤色 -->
  <path d="M 190,160 C 190,140 220,140 240,160 C 250,190 240,230 220,250 C 200,260 180,240 175,220 C 170,200 180,180 190,160 Z" fill="#e8bca0" />
  <!-- 胡须 (深色) -->
  <path d="M 200,230 C 210,240 230,240 240,230 C 235,245 220,250 210,245 Z" fill="#222222" />
  <!-- 眼睛/眉毛阴影 -->
  <path d="M 200,180 L 220,185 L 210,190 Z" fill="#ffffff" />
  <!-- 左眼高光 -->
  <path d="M 230,180 L 250,185 L 240,190 Z" fill="#ffffff" />
  <!-- 右眼高光 -->

  <!-- 5. 前景战甲：红色主体部分 -->
  <!-- 胸部和躯干红色 -->
  <path d="M 170,240 C 200,230 240,240 270,270 C 290,320 300,400 280,500 C 260,600 220,700 200,780 L 140,750 C 120,650 140,500 160,400 C 170,300 160,260 170,240 Z" fill="#c92a2a" />
  <!-- 红色战甲阴影/细节 -->
  <path d="M 170,240 L 220,260 L 200,300 L 160,280 Z" fill="#8e0000" />
  <path d="M 220,300 L 270,320 L 260,380 L 200,350 Z" fill="#8e0000" />
  <path d="M 160,400 L 220,420 L 200,480 L 150,450 Z" fill="#8e0000" />
  <!-- 腿部/下半身红色 -->
  <path d="M 140,600 C 180,580 220,600 240,650 L 220,780 L 160,800 Z" fill="#d32f2f" />

  <!-- 6. 前景战甲：金色/黄色部分 (手臂和手) -->
  <!-- 左侧前臂 (金色) -->
  <path d="M 130,420 C 160,410 190,430 200,470 L 190,540 C 170,550 140,540 130,500 Z" fill="#eebb44" />
  <path d="M 130,420 L 180,430 L 170,460 L 120,450 Z" fill="#f57f17" />
  <!-- 阴影 -->
  <!-- 右侧手部/前臂 (金色，画面右下) -->
  <path d="M 270,580 C 300,570 330,590 340,630 L 320,680 C 290,690 260,670 270,580 Z" fill="#eebb44" />
  <path d="M 270,580 L 320,590 L 310,620 L 260,610 Z" fill="#f57f17" />
  <!-- 阴影 -->
  <!-- 手指细节 -->
  <path d="M 320,630 L 340,640 L 335,660 L 315,650 Z" fill="#c92a2a" />

  <!-- 7. 前景胸口反应堆 (发光) -->
  <path d="M 250,330 C 250,310 270,310 280,330 C 290,360 270,390 250,380 C 230,370 240,350 250,330 Z" fill="#aaddff" />
  <path d="M 255,335 C 255,320 265,320 270,335 C 275,350 265,370 255,365 C 245,360 250,350 255,335 Z" fill="#ffffff" />

  <!-- 8. 前景左下手部/腿部细节 (红色/金色混合) -->
  <path d="M 140,720 L 180,740 L 170,790 L 130,770 Z" fill="#c92a2a" />
  <path d="M 160,700 L 190,720 L 180,760 Z" fill="#eebb44" />
