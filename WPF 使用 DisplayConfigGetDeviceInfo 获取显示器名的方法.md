...
1. 通过 GetDisplayConfigBufferSizes 和 QueryDisplayConfig 获取基础信息
2. 通过 DisplayConfigGetDeviceInfo 配合 DISPLAYCONFIG_DEVICE_INFO_GET_TARGET_NAME 获取显示器名
...
<!-- ![](image/WPF 使用 DisplayConfigGetDeviceInfo 获取显示器名的方法/WPF 使用 DisplayConfigGetDeviceInfo 获取显示器名的方法0.png) -->
![](http://cdn.lindexi.site/lindexi-20251210141841043.jpg)

本文代码放在 [github](https://github.com/lindexi/lindexi_gd/tree/12919d419d7988a99a6a72936ab0d987fed14be7/WPFDemo/RekafagigerjuNebecocaici) 和 [gitee](https://gitee.com/lindexi/lindexi_gd/tree/12919d419d7988a99a6a72936ab0d987fed14be7/WPFDemo/RekafagigerjuNebecocaici) 上，可以使用如下命令行拉取代码。我整个代码仓库比较庞大，使用以下命令行可以进行部分拉取，拉取速度比较快
